...
public class Sale05M27401_New extends bTransaction{
		...
		public boolean isBatchCheckOK(String stringValue) throws Throwable{
				if("新增".equals(stringValue) || "修改".equals(stringValue)){
						...
						if(stringContractDate.length() == 0){
								...
								//if(!("G".equals(stringStatus) || "GA".equals(stringStatus) || "I".equals(stringStatus))){ // 修改日期:20150811 員工編號:B3774
						...
						// Start 修改日期:20151120 員工編號:B3774
						//if(("N".equals(stringStatus) || "A".equals(stringStatus))  &&  stringCashInDate.length() == 0){
						...
						// Start 修改日期:20151120 員工編號:B3774
						//if(("G".equals(stringStatus) || "GA".equals(stringStatus) || "I".equals(stringStatus))  &&  stringTransferDate.length() == 0){
						...
						if(stringTransferDate.length() > 0){
								...
								// Start 修改日期:20151120 員工編號:B3774
								//if("G".equals(stringStatus) || "GA".equals(stringStatus) || "I".equals(stringStatus)){
								if("G".equals(stringStatus) || "GA".equals(stringStatus) || "GB".equals(stringStatus) || "I".equals(stringStatus)){
								// End 修改日期:20151120 員工編號:B3774
						...
						if("新增".equals(stringValue)){
								...
								if(!stringProjectID1.equals(getValue("ProjectID1_Old"))  ||  !stringContractDate.equals(getValue("ContractDate_Old"))  ||  !stringTransferDate.equals(getValue("TransferDate_Old"))){
								// End 修改日期:20150811 員工編號:B3774
					...
					//      }
						...
						if("新增".equals(stringValue)){
								...
								//比對 START
								stringSql = "select isnull('W'+right(convert(char(6),100000+right(max(BarCode),5)),5),'W00001') "+
												  "from Doc1M030 "+
												  "where BarCode like 'W%'";
								...
								if(!doc1M030Barcode.equals(sale05M274Barcode)) {
									...
									if(saleBarCodeNum > docBarCodeNum) {
										stringSql = "INSERT INTO Doc1M030 (BarCode,CDate,CTime,EDateTime,PreFinDate,KindNo,"+
														...
														"RealMoney,Remark,Hand,RecordNo,DocStatus,DocSpeed,KindNoD,PurConfirm,Urgent) "+
														"VALUES "+
														"('"+sale05M274Barcode+"','107/02/01','16:27:13','2018/02/01 16:27:13   ','2018/02/02','58','20','033H93A   '"+
								...
								//比對 END
								stringSql = "select isnull('W'+right(convert(char(6),100001+right(max(BarCode),5)),5),'W00001') "+
												  "from Doc1M030 "+
												  "where BarCode like 'W%'";
								retData = dbDoc.queryFromPool(stringSql);
						...
						//判斷流程設定是否完整
						/*
						boolean blnIsAll01        = true;
						boolean blnIsAllCS       = true;
						boolean blnHas01        = false;
						boolean blnHasCS       = false;
						int           intExtraStates = 4;
						for(int intRow=0; intRow<jtable14.getRowCount(); intRow++){
								if("01".equals(""+jtable14.getValueAt(intRow, 5))){
										blnHas01  = true;
										blnIsAllCS = false;
								}else if("CS".equals(""+jtable14.getValueAt(intRow, 5))){
										blnHasCS = true;
										blnIsAll01  = false;
								}else{
										blnIsAll01  = false;
						...
						if(blnIsAll01){
								intExtraStates = 4;
						}else if(blnIsAllCS  ||  (blnHasCS && !blnHas01)){
								intExtraStates = 2;
						}else if(blnHas01 && blnHasCS){
								intExtraStates = 2;
						}else{
								intExtraStates = 4;
						}
						stringSql = "SELECT count(distinct CensorSeq) "+
										  "FROM Sale05M225 "+
										  "WHERE FlowFormID='Sale05M27401' "+
										  "and ProjectID1='"+stringProjectID1+"'";
						retData = dbSale.queryFromPool(stringSql);
						// 直接抓出所有節點, 減掉承辦、End；非人壽要多減掉不動產、會計
						// Start 修改日期:20090819 員工編號:B3774
						//if(Integer.parseInt(retData[0][0]) != (getFlowStates().size()-intExtraStates)){
						if(Integer.parseInt(retData[0][0]) < (getFlowStates().size()-intExtraStates)){
						// End
								message("案別的簽核流程設定資料不完整!");
								return false;
						}
						*/
						// 各公司別合約編號
						...
						//if(("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "I".equals(stringStatus))  &&  
						// Start 修改日期:20100317 員工編號:B3774
						//if(("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "A".equals(stringStatus)  ||  "I".equals(stringStatus))  &&  
						// Start 修改日期:20120504 員工編號:B3774
						//if(("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "I".equals(stringStatus))  &&  
						// Start 修改日期:20151120 員工編號:B3774
						//if(("G".equals(stringStatus)  ||  "GA".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "CA".equals(stringStatus)  ||  "I".equals(stringStatus))  &&  
						...
						String stringTransferDate = getValue("TransferDate").trim();
						// Start 修改日期:20120504 員工編號:B3774
						//if("G".equals(stringStatus)  &&  stringTransferDate.length() == 0){
						if(("G".equals(stringStatus) || "GA".equals(stringStatus))  &&  stringTransferDate.length() == 0){
						// End 修改日期:20120504 員工編號:B3774
								message("[讓與日期] 不可為空白!");
								getcLabel("TransferDate").requestFocus();
								return false;
						...
						*/
						...
						//
						/*
						stringSql = "DELETE FROM Sale05M275_New WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M276 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M277 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M278 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						// Start 修改日期:20100412 員工編號:B3774
						stringSql = "DELETE FROM Sale05M308 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						// End 修改日期:20100412 員工編號:B3774
						stringSql = "DELETE FROM Sale05M279 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M281 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M282 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M283_New WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						// Start 修改日期:20100226 員工編號:B3774
						stringSql = "DELETE FROM Sale05M305 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						// End 修改日期:20100226 員工編號:B3774
						stringSql = "DELETE FROM Sale05M289 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M294 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						stringSql = "DELETE FROM Sale05M295 WHERE ContractNo='"+stringContractNoDB+"'";
						dbSale.execFromPool(stringSql);
						*/
						...
						// Start 修改日期:20091229 員工編號:B3774
						// Start 修改日期:20091230 員工編號:B3774
						//}else if("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "I".equals(stringStatus)){
						// Start 修改日期:20100317 員工編號:B3774
						//}else if("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "A".equals(stringStatus)  ||  "I".equals(stringStatus)){
						// Start 修改日期:20120504 員工編號:B3774
						//}else if("G".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "I".equals(stringStatus)){
						// Start 修改日期:20151120 員工編號:B3774
						//}else if("G".equals(stringStatus)  ||  "GA".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "CA".equals(stringStatus)  ||  "I".equals(stringStatus)){
						}else if("G".equals(stringStatus)  ||  "GA".equals(stringStatus)  ||  "GB".equals(stringStatus)  ||  "C".equals(stringStatus)  ||  "CA".equals(stringStatus)  ||  "I".equals(stringStatus)){
						// End 修改日期:20151120 員工編號:B3774
						// End 修改日期:20120504 員工編號:B3774
						// End 修改日期:20100317 員工編號:B3774
						// End 修改日期:20091230 員工編號:B3774
						...
						// End 修改日期:20100317 員工編號:B3774
								stringSql = "select HouseCar, Position "+
												  ...
												  "where ContractNo='"+stringContractNoDB+"' "+
												  "and CompanyCd='"+stringCompanyCdDB+"'";
												  // End 修改日期:20120517 員工編號:B3774
						...
						*/
						stringSql = "Insert into Sale05M304 "+
										  ...
										  "select '"+stringBarCode+"' BarCode, "+
										  "'"+stringStatus+"' Status, "+
										  "Contractno, "+
										  "CompanyCd, "+ // 修改日期:20120517 員工編號:B3774
										  "OrderNo, "+
										  "Position, "+
		...
		public void doInsertDoc1M030(String stringBarCode,     String stringCDate,            String stringCTime,
															...
															String stringComNo,       String stringDepartNo,       String stringEmployeeNo,
															String stringDocNo1,      String stringDocNo2,          String stringDocNo3,
															String stringDocNo,        String stringDescript,          String stringOriEmployeeName,
															String stringLastDepart, String stringLastDateTime, String stringInOut,
															String stringProjectID,	    String stringProjectID1,       String stringCostID,
				...
				stringSql = "INSERT INTO Doc1M030 (BarCode,                  CDate,         CTime, "+
																			 ...
																			 // End 修改日期:20100625 員工編號:B3774
																			 "ComNo,                    DepartNo,    EmployeeNo, "+
																			 "DocNo1,                   DocNo2,       DocNo3, "+
																			 "DocNo,                     DocClose,    Descript, "+
																			 "OriEmployeeName, LastDepart, LastDateTime, "+
																			 "InOut,                        Depart,        ProjectID, "+
																			 "ProjectID1,               CostID,         RealMoney, "+
																			 "Remark,                    Hand,           RecordNo, "+
																			 "DocStatus) "+
															" VALUES ( '" + stringBarCode                + "', " +
																			 " '" + stringCDate                    + "', " +
																			 " '" + stringCTime                    + "', " +
																			 " '" + stringEDateTime             + "', " +
																			 " '" + stringPreFinDate            + "', " +
		...
		//
		public void doInsertDoc1M040(String stringBarCode,     String stringCDate,      String stringCTime,
															String stringEDateTime, String stringDepartNo, String stringEmployeeNo) throws Throwable{
				String stringSql   = "";
				String retData[][] = null; // 修改日期:20151119 員工編號:B3774
				//
				stringSql = "INSERT INTO Doc1M040 (BarCode,             CDate,               CTime, "+
																			 "EDateTime,          DepartNo,        EmployeeNo, "+
																			 "CheckDateTime, CheckSecond, DocStatus) "+
															" VALUES ( '" + stringBarCode      + "', " +
																			 " '" + stringCDate          + "', " +
																			 " '" + stringCTime          + "', " +
																			 " '" + stringEDateTime   + "', " +
		...
		public void doModifyDoc1M030(String stringBarCode, String stringDescript) throws Throwable{
				String stringSql = "";
				//
				stringSql = "UPDATE Doc1M030 "+
								  "SET Descript='"+stringDescript+"' "+
								  "WHERE BarCode='"+stringBarCode+"'";
				dbDoc.execFromPool(stringSql);
		}
		...
		public void doDelDoc1M030040(String stringBarCode) throws Throwable{
				...
				//
				// Start 修改日期:20151119 員工編號:B3774
				stringSql = "DELETE FROM DOC1CM040 "+
								  "WHERE DI_AL_SERIAL IN (SELECT ID1 FROM Doc1M040 WHERE BarCode='"+stringBarCode+"')";
				dbDoc.execFromPool(stringSql);
				// End 修改日期:20151119 員工編號:B3774
				//
				stringSql = "DELETE FROM Doc1M040 "+
								  "WHERE BarCode='"+stringBarCode+"'";
				dbDoc.execFromPool(stringSql);
				//
				stringSql = "DELETE FROM Doc1M030 "+
								  "WHERE BarCode='"+stringBarCode+"'";
				dbDoc.execFromPool(stringSql);
		}
		...
		public boolean blnIsDispatch(String stringBarCode) throws Throwable{
				...
				//
				stringSql = "select DocStatus, count(*) "+
								  "from Doc1M040 "+
								  "where BarCode='"+stringBarCode+"' "+
								  "group by DocStatus";
				retData = dbDoc.queryFromPool(stringSql);
		...
		// End 修改日期:20120517 員工編號:B3774
				...
				stringSql = "select Position "+
								  ...
								  "and CompanyCd='"+stringCompanyCd+"' "+ // 修改日期:20120517 員工編號:B3774
								  "order by HouseCar desc, Position";
				retData = dbSale.queryFromPool(stringSql);
				for(int intRow=0; intRow<retData.length; intRow++){
						stringDescript = stringDescript.length()==0?retData[intRow][0]:
																							 (stringDescript + "," + retData[intRow][0]);
				}
				stringSql = "select CustomName, ContractSerialNo "+
								  "from Sale05M274 "+
								  // Start 修改日期:20120517 員工編號:B3774
								  //"where ContractNo='"+stringContractNo+"'";
								  "where ContractNo='"+stringContractNo+"' "+
