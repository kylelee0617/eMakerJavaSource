 ...
 *
 */
public class ImportUsingCustomer extends bproc {
  String 史大Date;
  String 安得Date;
  KSqlUtils ksUtil;
  KUtils kUtil;
  ...
  private void 執行() throws Throwable {
    ...
    // 建立com元件
    String filePath = "G:\\kyleTest\\Excel\\Test\\UsingCustomerVer3.xls";
    ...
    String[] title = { "訂單編號", "案別", "棟樓別" , "車位別" ,"客戶姓名" ,"客戶ID" ,"訂單日期" ,"簽約日期" ,"交屋日期" ,"退戶日" ,"退戶原因" //0-10
        ...
        ,"新客戶背景" ,"新往來通路" ,"新相關地域" ,"新往來產品" ,"新風險計算" ,"新風險等級" ,"是否異動" ,"行銷行業" ,"驗證400行業"};                          //17-25
...
//      tempArr[22] = "";
//      tempArr[23] = "";
      tempArr[24] = isNull(Dispatch.get(Dispatch.invoke(objectSheet1, "Range", Dispatch.Get, new Object[] { "X" + intRow }, new int[1]).toDispatch(), "Value").toString());
