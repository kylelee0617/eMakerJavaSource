...
public class Data220615 extends bproc {
  String 史大Date;
  String 安得Date;
  KSqlUtils ksUtil;
  KUtils kUtil;
  ...
  private void 執行() throws Throwable {
    ...
    String sql = "select DISTINCT   " //購屋證明單 - 客戶
        ...
        + "from Sale05M070 t70  " 
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '購屋%' and t70.RecordType like '客戶%'  " 
        ...
        + "ISNULL( STUFF( (SELECT ',' + aa.AgentReason FROM Sale05M091Agent aa WHERE aa.OrderNo = t70.OrderNo and ISNULL(aa.StatusCd , '') != 'C' FOR XML PATH('')) , 1, 1, '') , '') as 代理原因  " 
        + "from Sale05M070 t70  " 
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '購屋%' and t70.RecordType like '實質受益人%'  " 
        + "and ISNULL( STUFF( (SELECT ',' + t92.[Position] FROM Sale05M092 t92 WHERE t70.OrderNo = t92.OrderNo FOR XML PATH('')) , 1, 1, '') , '') != ''   " 
        ...
        + "ISNULL( STUFF( (SELECT ',' + aa.AgentReason FROM Sale05M091Agent aa WHERE aa.OrderNo = t70.OrderNo and ISNULL(aa.StatusCd , '') != 'C' FOR XML PATH('')) , 1, 1, '') , '') as 代理原因  " 
        + "from Sale05M070 t70  " 
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '購屋%' and t70.RecordType like '代理人%'  " 
        + "and ISNULL( STUFF( (SELECT ',' + t92.[Position] FROM Sale05M092 t92 WHERE t70.OrderNo = t92.OrderNo FOR XML PATH('')) , 1, 1, '') , '') != ''   " 
        ...
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '收款%'   " 
        + "and ISNULL( STUFF( (SELECT ',' + t92.[Position] FROM Sale05M092 t92 WHERE t70.OrderNo = t92.OrderNo FOR XML PATH('')) , 1, 1, '') , '') != ''  " 
        ...
        + "from Sale05M070 t70 " 
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '合約%' and RecordType like '%附件-指定第三人%' " 
        ...
        + "ISNULL( STUFF( (SELECT ',' + aa.AgentReason FROM Sale05M091Agent aa WHERE aa.OrderNo = t70.OrderNo and ISNULL(aa.StatusCd , '') != 'C' FOR XML PATH('')) , 1, 1, '') , '') as 代理原因  " 
        + "from Sale05M070 t70  " 
        + "where RecordDesc != '不適用' and RecordDesc != '不符合' and t70.Func like '退戶%'  "  
