...
public class FuncDelete extends bTransaction {
  public boolean action(String value) throws Throwable {
     ...
     * 
     * showForm("購屋證明單-同步-行銷(Sale02M030)"); setValue("OrderNo",OrderNo);
    ...
    String stringSQL = "";
    //
    stringSQL = "SELECT ProjectID1 " + " FROM Sale05M090 " + " WHERE OrderNo = '" + getValue("OrderNo").trim() + "'";
    ...
    //
    stringSQL = "SELECT HouseCar, " + " Position " + " FROM Sale05M092 " + " WHERE OrderNo = '" + getValue("OrderNo").trim() + "'";
    ...
    for (int intSale05M092 = 0; intSale05M092 < retSale05M092.length; intSale05M092++) {
      ...
      // UPDATE A_Sale
      stringSQL = "UPDATE " + stringA_Sale + " SET YearMM = ''," + " Depart = 0," + "	Custom =''," + "	OrderDate =''," + "	OrderMon = 0," + "	H_OrderMon = 0,"
          + "	L_OrderMon = 0," + "	EnougDate =''," + "	EnougMon = 0," + "	H_EnougMon = 0," + "	L_EnougMon = 0," + "	ContrDate =''," + "	ContrMon = 0," + "	H_ContrMon = 0,"
          + "	L_ContrMon = 0," + "	Deldate =''," + "	PingSu = 0," + "	DealDiscount = 0," + "	BonusDiscount = 0," + "	PreMoney = 0," + "	H_PreMoney = 0," + "	L_PreMoney = 0,"
          + "	DealMoney = 0," + "	H_DealMoney = 0," + "	L_DealMoney = 0," + "	GiftMoney = 0," + "	H_GiftMoney = 0," + "	L_GiftMoney = 0," + "	CommMoney = 0," + "	H_CommMoney = 0,"
          + "	L_CommMoney = 0," + "	CommMoney1 = 0," + // 2015-10-13 B3018 增加中原佣金
          ...
          + "	SaleName4 =''," + "	SaleID5 =''," + "	SaleName5 =''," + "	SaleID6 =''," + // 增加售出人 20090414
          "	SaleName6 =''," + // 增加售出人 20090414
          "	SSMediaID =''," + // 增加 媒體 2015-06-01
          "	SSMediaID1 =''," + // 增加 媒體細項 2015-06-01
          "	SaleGroup =''," + "	MediaID =''," + "	MediaName =''," + "	ZoneID =''," + "	ZoneName =''," + "	MajorID =''," + "	MajorName =''," + "	UseType =''," + "	Remark ='',"
          + "	DateRange =''," + "	DateCheck =''," + "	DateFile =''," + "	DateBonus =''," + "	RentRange = 0," + "	PingRentPrice = 0," + "	PingRent = 0," + "	PingRentLast = 0,"
          + "	RentPrice = 0," + "	Rent = 0," + "	RentLast = 0," + "	Guranteer = 0," + "	RentFree = 0," + "	Position1 =''," + "	PositionRent1 =''," + "	Custom1 ='',"
          + "	ViMoney = 0," + "	H_ViMoney = 0," + "	L_ViMoney = 0," + "	AO_sn = 0," + "	Plan1 =''," + "	ComNo =''," + "	OrderNo ='', " + "	SaleID7 =''," + // 增加售出人 20090525
    ...
    // ------------------------------------------
    /*
     * talk dbSale = getTalk(""+get("put_dbSale")); String stringSQL = " INSERT  " +
     * " INTO Sale02M030 " + " ( " + " OP," + " Type," + " TypeNo," + " DateTime " +
     * " ) " + " VALUES " + " ( " + "N'DELETE',"+ "N'購屋',"+ "'" + OrderNo + "',"+
