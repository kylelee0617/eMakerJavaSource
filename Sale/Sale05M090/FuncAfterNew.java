...
public class FuncAfterNew extends bNotify{
    ...
    System.out.println("洗錢防治相關-------------------------------------E") ;
		...
		stringSQL = "SELECT HouseCar, " +
										 ...
										 " CommMoney, " +
										 " ViMoney, " +			
										 " CommMoney1 " +  // 增加 [中原佣金] 楊信義 2015/10/13						 											 											 											 											 											 
							  " FROM Sale05M092 " +
							" WHERE OrderNo = '" + getValue("OrderNo").trim() + "'" +
		   ...
		   stringSQL = "UPDATE " + stringA_Sale +
			...
			String stringPureMoney = "" + (Double.parseDouble(stringDealMoney) - 
		   	...
		   	stringSQL = stringSQL	+ 
								...
								" CommMoney1 = " + convert.FourToFive(stringCommMoney1,  4) + "," + 																					// 2015-10-13 B3018中原佣金
								...
								" SSMediaID  =  '"    +  retSale05M090[0][30].trim()  +  "', "  +   	// 增加[媒體代碼 2010/04/21
