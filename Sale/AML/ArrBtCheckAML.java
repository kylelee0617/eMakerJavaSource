 ...
 *
 */
public class ArrBtCheckAML extends jcx.jform.sproc {
...
//    System.out.println(">>>BTCHECKAML_RQ:" + get("BTCHECKAML_RQ"));
    ...
    for (int i = 0; i < checkAMLs.length; i++) {
      ...
      if(qBean == null || StringUtils.isBlank(qBean.getRealName(custNo))) {
        System.out.println("BtCustAML : QueryLogBean is null");
        return value;
      }
