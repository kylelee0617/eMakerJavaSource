...
public class CheckAML2 extends bproc{
  public String getDefaultValue(String value)throws Throwable{
    ...
    //22. Rule22 長官要求速度，所以照上面隨便寫寫
    String amlDesc22 = amlTool.getAMLReTurn().get("22").toString()
        .replaceAll("<customName>", allCustomName).replaceAll("<customTitle>", "客戶").replaceAll("<customName2>", "").replaceAll("<customTitle2>", "");
    if(StringUtils.equals(rule22, "Y")) {
      ...
      strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) "
          + "VALUES ('"+strDocNo+"','"+strOrderNo+"','"+strProjectID1+"','"+intRecordNo+"','"+actionNo+"','收款','客戶資料','"+strActionName+"','"+amlDesc22+"','"+allCustomID+"','"+allCustomName+"','"+strEDate+"','RY','773','022','"+amlDesc22+"','"+empNo+"','"+RocNowDate+"','"+strNowTime+"')";
      dbSale.execFromPool(strSaleSql);
      intRecordNo++;
      //AS400
      strJGENLIBSql = "INSERT INTO PSHBPF (SHB00, SHB01, SHB03, SHB04, SHB05, SHB06A, SHB06B, SHB06, SHB97, SHB98, SHB99) "
          + "VALUES ('RY', '"+strDocNo+"', '"+RocNowDate+"', '"+strDeputyID+"', '"+strDeputyName+"', '773', '022', '"+amlDesc22+"','"+empNo+"','"+RocNowDate+"','"+strNowTime+"')";
      dbJGENLIB.execFromPool(strJGENLIBSql);
      ...
      //不符合
      strSaleSql = "INSERT INTO Sale05M070 (DocNo,OrderNo,ProjectID1,RecordNo,ActionNo,Func,RecordType,ActionName,RecordDesc,CustomID,CustomName,EDate,SHB00,SHB06A,SHB06B,SHB06,SHB97,SHB98,SHB99) "
          + "VALUES ('"+strDocNo+"','"+strOrderNo+"','"+strProjectID1+"','"+intRecordNo+"','"+actionNo+"','收款','客戶資料','"+strActionName+"','不符合','"+allCustomID+"','"+allCustomName+"','"+strEDate+"','RY','773','022','"+amlDesc22+"','"+empNo+"','"+RocNowDate+"','"+strNowTime+"')";
      dbSale.execFromPool(strSaleSql);
      intRecordNo++;
    }
