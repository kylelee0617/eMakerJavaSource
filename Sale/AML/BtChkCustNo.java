...
public class BtChkCustNo extends bproc{
  public String getDefaultValue(String value)throws Throwable{
    ...
    // 取得黑名單
    QueryLogBean qBean = ksUtil.getQueryLogLike3(projectID, payment_custNo);
    if ( qBean == null || StringUtils.isBlank(qBean.getRealName(payment_custNo)) ) {
      messagebox("ID: " + payment_custNo + " 查無資料，請先執行黑名單查詢。");
      return value;
    }

    String errMsg = "";
    
    String name = qBean.getRealName(payment_custNo);
