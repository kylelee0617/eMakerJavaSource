...
public class Sale05M040N extends bproc {
  ...
  public boolean doUpdate(FargloryUtil exeUtil) throws Throwable {
    ...
    // 車位價目表
    String[] arrayCarField = { "車位別", "價目表NO", "公司別代碼-車位建物", "公司別", "公司別代碼-車位土地", "公司別", "樓層", "性質", "類別", "size", "產品別代碼", "產品別", "權狀Y/N", "表價", "表價-車位建物款", "表價-車位土地款", "底價",
        "底價-車位建物款", "底價-車位土地款", "租售並進", "遠壽代銷關係", "車位類別-代碼", "車位類別", "車位持分面積", "主要用途", // 2012-12-11 B3018 增加 主要用途
        "持分比例-車位建物", "持分比例-車位土地", "委託銷售人-車房", "受託銷售人-車房", "委託銷售人-車土", "受託銷售人-車土", "代收公司別-車房", "代收公司別-車土" }; // 2014-02-10 B3018 修改
    String[] arrayHouseField = { "棟別", "樓別", "戶別", "價目表NO", "公司別代碼-房屋", "公司別", "公司別代碼-土地", "公司別", "產品別代碼", "產品別", "坪數", "牌單", "牌價", "牌價-房屋", "牌價-土地", "底單", "底價", "底價-房屋", "底價-土地",
        "租售並進", "遠壽代銷關係", "主要用途", "建物型態-代碼", "建物型態", "房", "廳", "衛", "隔間", "持分比例-房屋", "持分比例-土地", "委託銷售人-房屋", "受託銷售人-房屋", "委託銷售人-土地", "受託銷售人-土地", "代收公司別-房屋", "代收公司別-土地" }; // 2014-02-10
                                                                                                                                                                          // B3018
                                                                                                                                                                          // 修改
    ...
    for (int intFieldNo = 0; intFieldNo < arrayCarField.length; intFieldNo++) {
      ...
      // System.out.println(intFieldNo + "------" +
      // arrayCarField[intFieldNo]+"---------------"+stringTemp) ;
    ...
    if ("全部".equals(stringType) || "房屋".equals(stringType)) {
      ...
      for (int intRowNo = 1; intRowNo < intHouseTotalRow; intRowNo++) {
        ...
        // System.out.println("1房屋---stringPosition:"+stringPosition + "
        // stringLCom:"+stringLCom);
        ...
        // System.out.println("1-"+intRowNo+"房屋
        // stringHratio("+stringHratio+")stringLratio("+stringLratio+")---------------------------------------------")
        // ;
    ...
    if ("全部".equals(stringType) || "車位".equals(stringType)) {
      ...
      for (int intRowNo = 1; intRowNo < intCarTotalRow; intRowNo++) {
        ...
        if (stringLCom.equals("null")) stringLCom = "";
        // Start 修改日期:20100507 員工編號:B3774
        ...
        if ("null".equals(stringILCom)) stringILCom = ""; // 2014-02-10 B3018 新增
        //
        // System.out.println("stringPosition :"+ stringPosition + " stringSaleKind
        // :"+stringSaleKind+ "stringHCom"+stringHCom + "stringLCom"+stringLCom);
        if ("null".equals(stringSaleKind) || "".equals(stringSaleKind)) {
          stringSaleKind = "N";
        }
        if ("null".equals(stringSaleFlag)) {
      ...
      for (int intRowNo = 1; intRowNo < intCarTotalRow2; intRowNo++) {
        ...
        // 新增
        if (getSale05M092Count(stringPosition) <= 0) {
          stringSql = getInsertC_Sale05M342(stringPosition, stringListPriceNo, stringHCom, stringLCom, stringTypeNo, stringPingSu, stringListUintPrice, stringListPrice,
              stringHListPrice, stringLListPrice, stringFloorUnitPrice, stringFloorPrice, stringHFloorPrice, stringLFloorPrice, "Car", stringSaleKind, stringCarKind1,
    ...
    stringMessage += " 　　　房屋價目表 已轉入" + intRecord + "筆";
    // 實際寫作資料庫中
    // if(vectorSql.size( ) > 0) dbSale.execFromPool((String[])
    // vectorSql.toArray(new String[0])) ;
    // 釋放 Excel 物件
    getReleaseExcelObject(retVector);
    return true;
  }
  ...
  public String getInsert(String stringPosition, String stringListPriceNo, String stringHCom, String stringLCom, String stringTypeNo, String stringPingSu,
      String stringListUintPrice, String stringListPrice, String stringHListPrice, String stringLListPrice, String stringFloorUnitPrice, String stringFloorPrice,
      String stringHFloorPrice, String stringLFloorPrice, String stringHouseCar, String stringSaleKind) throws Throwable {
    String stringSql = "";
    String stringProjectId = getValue("ProjectId").trim();
    //
    stringSql = "INSERT  INTO  Sale05M040 (ProjectID1,     HouseCar,   Position,            ListPriceNo,     H_Com, "
        ...
        + " L_FloorPrice ,SaleKind,EmployeeNo, EDateTime)  VALUES ( '" + stringProjectId + "',  '" + stringHouseCar + "', " + // 例外，14
  ...
  // Start 修改日期:20100507 員工編號:B3774
  public String getInsertC(String stringPosition, String stringListPriceNo, String stringHCom, String stringLCom, String stringTypeNo, String stringPingSu,
      String stringListUintPrice, String stringListPrice, String stringHListPrice, String stringLListPrice, String stringFloorUnitPrice, String stringFloorPrice,
      String stringHFloorPrice, String stringLFloorPrice, String stringHouseCar, String stringSaleKind, String stringCarKind1, String stringCarKind2, String stringCarSize,
      String stringCarPaper, String stringSaleFlag, String stringCarCd, String stringCarType, String stringCarArea, String stringCarHratio, String stringCarLratio,
      String stringCarAHCom, String stringCarBHCom, String stringCarALCom, String stringCarBLCom, String stringCarMainUse, String stringCarVisionKind, String stringCarVision,
      String stringIHCom, String stringILCom) throws Throwable {
    String stringSql = "";
    String stringProjectId = getValue("ProjectId").trim();
    ...
    stringSql = "INSERT INTO Sale05M040 (ProjectID1,     HouseCar,        Position,            ListPriceNo,    H_Com, "
        ...
        + "H_ListPrice,    L_ListPrice,      FloorUnitPrice,  FloorPrice,      H_FloorPrice, L_FloorPrice, SaleKind,           CarKind1,         CarKind2,      CarSize,    "
        + "CarPaper,       EmployeeNo,     EDateTime,      SaleFlag,       CarCd,  CarType,         CarArea,           CarHratio,         CarLratio,      CarAH_Com, "
        + "CarBH_Com,    CarAL_Com,    CarBL_Com,     Hratio,            Lratio,  CarMainUse,    CarVisionKind ,CarVision,         IH_Com,         IL_Com, "
        + " StartUseDate,  CheckDateTime,  CheckMan) VALUES ( '" + stringProjectId + "',  '" + stringHouseCar + "', " + // 例外，14
        " '" + stringPosition + "',  '" + stringListPriceNo + "',  '" + stringHCom + "', " + // 04
        " '" + stringLCom + "',  '" + stringTypeNo + "', " + stringPingSu + ", " + stringListUintPrice + ", " + stringListPrice + ", " + // 09
        stringHListPrice + ", " + stringLListPrice + ", " + stringFloorUnitPrice + ", " + stringFloorPrice + ", " + stringHFloorPrice + ", " + // 14
        stringLFloorPrice + ",  '" + stringSaleKind + "',  '" + stringCarKind1 + "',  '" + stringCarKind2 + "',  '" + stringCarSize + "', " + // 19
  ...
  // End 修改日期:20100507 員工編號:B3774
  public String getInsertC_Sale05M342(String stringPosition, String stringListPriceNo, String stringHCom, String stringLCom, String stringTypeNo, String stringPingSu,
      String stringListUintPrice, String stringListPrice, String stringHListPrice, String stringLListPrice, String stringFloorUnitPrice, String stringFloorPrice,
      String stringHFloorPrice, String stringLFloorPrice, String stringHouseCar, String stringSaleKind, String stringCarKind1, String stringCarKind2, String stringCarSize,
      String stringCarPaper, String stringSaleFlag, String stringCarCd, String stringCarType, String stringCarArea, String stringCarHratio, String stringCarLratio,
      String stringCarAHCom, String stringCarBHCom, String stringCarALCom, String stringCarBLCom, String stringCarMainUse, String stringCarVisionKind, String stringCarVision,
  ...
  public String getInsertH(String stringPosition, String stringListPriceNo, String stringHCom, String stringLCom, String stringTypeNo, String stringPingSu,
      String stringListUintPrice, String stringListPrice, String stringHListPrice, String stringLListPrice, String stringFloorUnitPrice, String stringFloorPrice,
      String stringHFloorPrice, String stringLFloorPrice, String stringHouseCar, String stringSaleKind, String stringTotalSquare, String stringVisionKind, String stringVision,
      String stringSaleFlag, String stringMainUse, String stringBuildCd, String stringBuildType, String stringBuild1, String stringBuild2, String stringBuild3, String stringBuild4,
      String stringHratio, String stringLratio, String stringAHCom, String stringBHCom, String stringALCom, String stringBLCom, String stringIHCom, String stringILCom)
      throws Throwable {
    String stringSql = "";
    String stringProjectId = getValue("ProjectId").trim();
    String stringStartUseDate = getValue("StartUseDate").trim(); // 2017-06-02 B3018 增加
    ...
    stringSql = "INSERT INTO Sale05M040 (ProjectID1,     HouseCar,   Position,           ListPriceNo,   H_Com, "
        ...
        + " BL_Com,         CarHratio,    CarLratio,        CarMainUse, CarVisionKind,  CarVision,       IH_Com,       IL_Com,            StartUseDate,  CheckDateTime, "
        + " CheckMan )  VALUES ( '" + stringProjectId + "', " + // 0
        " '" + stringHouseCar + "',  '" + stringPosition + "',  '" + stringListPriceNo + "',  '" + stringHCom + "', " + // 4
        " '" + stringLCom + "',  '" + stringTypeNo + "', " + stringPingSu + ", " + stringListUintPrice + ", " + stringListPrice + ", " + // 9
        stringHListPrice + ", " + //
        stringLListPrice + ", " + stringFloorUnitPrice + ", " + stringFloorPrice + ", " + stringHFloorPrice + ", " + // 14
        stringLFloorPrice + ",  '" + stringSaleKind + "'  , '" + getUser() + "', '" + datetime.getTime("YYYY/mm/dd h:m:s") + "',  " + stringTotalSquare + "," + // 19
        " '" + stringVisionKind + "',  " + stringVision + ", '" + stringSaleFlag + "', " + // 2012/06/29 B3018 修改
  ...
  // End 修改日期:20100426 員工編號:B3774
  public String getInsertH_Sale05M342(String stringPosition, String stringListPriceNo, String stringHCom, String stringLCom, String stringTypeNo, String stringPingSu,
      String stringListUintPrice, String stringListPrice, String stringHListPrice, String stringLListPrice, String stringFloorUnitPrice, String stringFloorPrice,
      String stringHFloorPrice, String stringLFloorPrice, String stringHouseCar, String stringSaleKind, String stringTotalSquare, String stringVisionKind, String stringVision,
      String stringSaleFlag, String stringMainUse, String stringBuildCd, String stringBuildType, String stringBuild1, String stringBuild2, String stringBuild3, String stringBuild4,
      String stringHratio, String stringLratio, String stringAHCom, String stringBHCom, String stringALCom, String stringBLCom, String stringIHCom, String stringILCom)
  ...
  public Vector getExcelObject(String stringExcelName) {
    ...
    // objectWorkbook = Dispatch.call(objectWorkbooks, "Open",
    // "http://mis_emaker1:8080/farglory/Sale/Sale05R120.xls").toDispatch();
    ...
    // Object objectSheet1 = Dispatch.call(objectSheets, "Item", new
    // Variant(3)).toDispatch() ;
    Object objectSheet2 = Dispatch.call(objectSheets, "Item", "房屋價目表").toDispatch();
    // Object objectSheet2 = Dispatch.call(objectSheets, "Item", new
    // Variant(4)).toDispatch() ;
