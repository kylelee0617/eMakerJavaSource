...
public class Sale01R071N extends bproc {
    ...
    for (int intRow = 2; intRow < 70; intRow++) {
      ...
      for (int intCol = 4; intCol < 19; intCol++) {
        ...
        if ("業績目標".equals(stringTitle1)) {
          stringValue = "" + hashtableTargetsMoney.get(stringMonth);
          if (exeUtil.doParseDouble(stringValue) == 0) stringValue = "0";
          // stringMessage += "\n\n業績目標 Excel("+stringMonth+")("+stringValue+")\n" ;
        } else if ("實際業績".equals(stringTitle1)) {
          stringValue = "" + hashtableDealMoney.get(stringMonth);
          if (exeUtil.doParseDouble(stringValue) == 0) stringValue = "0";
  ...
  public String getRequestMoneyForCostID(String stringMessage, String stringYYMM, String stringCostIDs, Hashtable hashtableUseMoney, FargloryUtil exeUtil) throws Throwable {
    ...
    for (int intNo = 0; intNo < arrayCostID.length; intNo++) {
      stringCostID = arrayCostID[intNo];
    ...
    for (int intNo = 0; intNo < vectorCostID.size(); intNo++) {
      ...
      if ("".equals(stringCostID) || "null".equals(stringCostID)) continue;
      stringKey = stringCostID + "%-%" + stringYYMM;
      //
      doubleRequestMoneySum += exeUtil.doParseDouble("" + hashtableUseMoney.get(stringKey));
  ...
  public String doUseMoneyForASale(String stringMessage, FargloryUtil exeUtil, talk dbDoc, talk dbDocCS, talk dbSale, Hashtable hashtableUseMoney) throws Throwable {
    ...
    if ("A".equals(stringSourceType)) {
      ...
      for (int intNo = 0; intNo < arrayKEY.length; intNo++) {
        ...
        // stringMessage +=
        // arrayKEY[intNo]+"動支("+retData.length+")-----------------------------S\n" ;
  ...
  public String[][] getRealMoneyForDoc3M014UseMoneyACView(String stringProjectID1, String stringSize, String stringDateS, String stringDateE, String stringType, talk dbDoc)
      throws Throwable {
    String stringSql = "";
    String stringSqlAnd = "";
  ...
  public String[][] getRequestMoneyForDoc2M012(String stringProjectID1, String stringSize, String stringDateS, String stringDateE, String stringType, FargloryUtil exeUtil,
  ...
  public String[][] getRequestMoneyForDoc6M012(String stringDBSource, String stringProjectID1, String stringSize, String stringDateS, String stringDateE, String stringType,
  ...
  public String[][] getRequestMoneyForDoc6M0121(String stringProjectID1, String stringSize, String stringDateS, String stringDateE, String stringType, FargloryUtil exeUtil,
      talk dbDoc) throws Throwable {
    String stringSql = "";
    String stringSqlAnd = "";
    String stringSqlItem = "";
  ...
  /**
   * 2022/01/24更新 : 加入可選A_SALE參照哪個日期欄位
   * 
   * @param stringProjectID1
   * @param stringSize
   * @param stringDateS
   * @param stringDateE
   * @param dbSale
  ...
  public String[][] getDealMoneyForASale(String stringProjectID1, String stringSize, String stringDateS, String stringDateE, talk dbSale) throws Throwable {
    ...
    if (!"".equals(stringDateS)) stringSql += " AND  "+dateType+" >=  '" + stringDateS + "'  \n";
    if (!"".equals(stringDateE)) stringSql += " AND  "+dateType+" <=  '" + stringDateE + "'  \n";
    if (!"".equals(stringProjectID1)) {
  ...
  public String[][] getRealMoneyHandForZCoReaMM(String stringProjectID1, String stringSize, String stringType, String stringDateACS, String stringDateACE, FargloryUtil exeUtil,
      talk dbSale) throws Throwable {
    String stringSql = "";
    String stringSqlAnd = "";
    String stringSqlItem = "";
    String[][] retData = null;
