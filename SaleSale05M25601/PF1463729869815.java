...
public class PF1463729869815 extends bvalidate{
  public boolean check(String value)throws Throwable{
    ...
    if(blnHasPositionSelfPayment){
      ...
      //20230303 Kyle 申請書增加 1.本次請款次數 & 2.總請款次數，用以判斷若微最後一次請款，則[本次請款金額]=未請款金額
        stringSql = "select T264.OrderNo, T264.PingSu, "+
                      ...
                      ",T268.RequestPaymentTimes " + //Kyle 230303
                      ",(select MAX(RequestPaymentTimes) from Sale05M268 tt268 where tt268.ProjectID1=T268.ProjectID1 and tt268.ObjectCd=T268.ObjectCd AND RequestPaymentTimes != 'all') " + //Kyle 230303
        ...
        stringSql = "select T264.OrderNo, T264.PingSu, "+
                      ...
                      ",T266.RequestPaymentTimes " +  //Kyle 230303
                      ",(select MAX(RequestPaymentTimes) from Sale05M266 tt266 where tt266.ProjectID1=T266.ProjectID1 and tt266.ObjectCd=T266.ObjectCd AND RequestPaymentTimes != 'all') " + //Kyle 230303
    ...
    if(retData.length > 0){
      ...
      // 本次可請款金額 || 實際請款金額
      if(StringUtils.equals(retData[0][17].trim(), retData[0][18].trim())) {  //如果是最後一次...
        setValueAt("table3",  retData[0][14],  intRow,  "ValidRequestPaymentMoney");
        setValueAt("table3",  retData[0][14],  intRow,  "RealRequestPaymentMoney");
      }else {
