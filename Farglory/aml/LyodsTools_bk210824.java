...
public class LyodsTools_bk210824 extends bvalidate {
  // DB
  talk db400 = null;
  talk dbSale = null;
  talk dbEIP = null;
  ...
  public LyodsTools_bk210824() throws Throwable {
  }

  public LyodsTools_bk210824(AMLyodsBean lyodsBean) throws Throwable {
  ...
  public Result checkRisk() throws Throwable {
    ...
    */
//    System.out.println(">>>indCode:" + industryCode);

    // 經理人?
    String isManager = kSqlUtil.isManager(cBean.getPositionName());
    /*
...
//    System.out.println(">>>cnyCode:" + cnyCode);
    ...
    try {
      ...
      mainQuery.setRegisterNation("");                      // 居住地國籍  同nation2
      mainQuery.setBirthNation(cnyCode);                    // 出生地國籍  同nation1
