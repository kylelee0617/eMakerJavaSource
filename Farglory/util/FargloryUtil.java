...
public class FargloryUtil extends bvalidate {
  ...
  public String[] getOrderList(String stringType, String[] arrayData) throws Throwable {
    ...
    String[] arrayOrderPOS = new String[arrayData.length];
    for (int intNo = 0; intNo < arrayOrderPOS.length; intNo++)
      arrayOrderPOS[intNo] = "";
    ...
    for (int intNo = 0; intNo < arrayData.length; intNo++) {
      ...
      for (int intNoL = 0; intNoL < arrayData.length; intNoL++) {
        stringValue = arrayData[intNoL].trim();
        if (doParseDouble(stringValue) == 0) continue;
        //
  ...
  public boolean isDigitNum(String stringValue) throws Throwable {
    ...
    for (int intNo = 0; intNo < arrayChar.length; intNo++) {
      ...
      if (".".equals("" + charWord) && stringValue.substring(intNo + 1).indexOf(".") == -1) {
        continue;
      }
  ...
  public String getNormalFont(String stringValue) throws Throwable {
    ...
    for (int intNo = 0; intNo < stringValue.length(); intNo++) {
      ...
      //
      intPos = stringBigFont.indexOf(stringChar);
      if (intPos == -1) continue;
      // System.out.println("("+stringBigFont.substring(intPos,
      // intPos+1)+")("+stringSmallFont！.substring(intPos,
      // intPos+1)+")---------------------------") ;
  ...
  public String getFormatNum2(String stringValue) throws Throwable {
    ...
    if (arrayTemp.length == 2 && !"".equals(arrayTemp[1])) {
      ...
      for (int intNo = 0; intNo < stringTemp.length(); intNo++)
        stringType += "9";
    }
    //
  ...
  public String getDateMonthEnd(String stringDate) throws Throwable {
    ...
    if ("ROC".equals(stringYearType)) {
      stringDateRoc = stringDateRoc.replaceAll("/", "");
      if (stringDateRoc.length() != 7) return "";
      ...
      stringDateAC = stringDateAC.replaceAll("/", "");
      if (stringDateAC.length() != 8) return "";
  ...
  public String getDateAC(String value, String stringErrorFieldName) throws Throwable {
    ...
    booleanFlow = booleanFlow && ((retArray.length == 1 && value.length() != 8) || (retArray.length != 1));
    if (booleanFlow) {
      return "[" + stringErrorFieldName + "] 日期格式錯誤(YYYY/MM/DD)。";
    }
    stringTmp = "";
    booleanFlow = true;
    if (retArray[0].length() < 4) stringTmp = "0" + retArray[0].trim();
    else
  ...
  // 判斷 if(!(stringVoucherYMD.length()==8 || (stringVoucherYMD.length()==9 &&
  // datetime.getYear(stringVoucherYMD.replaceAll("/", "")).length()==3))) {
  ...
  public static String getDateRoc(String stringRocDate, String stringErrorFieldName, String stringType) throws Throwable {
    ...
    stringTmp = "";
    booleanFlow = true;
    if (retArray[0].length() < 2) stringTmp = convert.add0(retArray[0].trim(), "" + 2);
    else
  ...
  public void doEMail(String stringSubject, String stringContentL, String stringSend, String stringErrSend, String[] arrayFileName, String stringFilePath, String[] arrayUser)
      throws Throwable {
  ...
  public void doAllEMail(String stringSubject, String stringContentL, String stringSend, String stringErrSend, String[] arrayFileName, String stringFilePah, String[] arrayUser)
      throws Throwable {
  ...
  public void doAllEMailFinal(String stringSubject, String stringContentL, String stringSend, String[] arrayErrSend, String[] arrayFileName, String stringFilePah,
      String[] arrayUser) throws Throwable {
    arrayUser = getMailTail(arrayUser);
    if (arrayUser.length == 0) return;
  ...
  public void doMail(String stringSubject, String stringContentL, String stringSend, String stringErrSend, String[] arrayFileName, String stringFilePath, String[] arrayUser)
      throws Throwable {
    String[] arrayUserL = new String[1];
    for (int intNo = 0; intNo < arrayUser.length; intNo++) {
      arrayUserL[0] = arrayUser[intNo];
  ...
  public void doAllMail(String stringSubject, String stringContent, String stringSend, String stringErrSend, String[] arrayFileName, String stringFilePath, String[] arrayUser)
      throws Throwable {
    String[] arrayErrSend = null;
    if (!"".equals(stringErrSend)) {
      arrayErrSend = new String[1];
  ...
  public void doAllMailFinal(String stringSubject, String stringContent, String stringSend, String[] arrayErrSend, String[] arrayFileName, String stringFilePath,
      String[] arrayUser) throws Throwable {
  ...
  public void doAllMailFinalUTF8(String stringSubject, String stringContent, String stringSend, String[] arrayErrSend, String[] arrayFileName, String stringFilePath,
      String[] arrayUser) throws Throwable {
  ...
  // e-office E-mail 通知
  // 存放於 資料庫 IntraWare中
  // arrayUser(收信者s-員工編號) stringSend(送信者-員工編號) stringSendView(送信者名稱)
  // stringBody(主要內容)
  // 資料庫 IntraWare
  // exeUtil.doExtWebMail("TEST", "TEST_CONTENT", "B3018", "楊信義", arrayEmp,
  // dbIntraWare) ;
  public void doExtWebMail(String stringSubject, String stringContent, String stringSend, String stringSendView, String[] arrayUser, talk dbIntraWare) throws Throwable {
    ...
    for (int intNo = 0; intNo < arrayUser.length; intNo++) {
      ...
      stringSql = "INSERT  INTO  extwebmail_mail(employ_no,  folder_kn,  fromname,  fromaddr,  rcptshort, " + " inrcpt,     indate,     subject,   body,      charset, "
          + " priority,   ishtml,     mailsize,  isread,    isconfirm, " + " mailstatus) " + " VALUES( '" + stringEmp + "', " + // employ_no
          " '" + "@.mail" + "', " + // folder_kn
    ...
    for (int intNo = 0; intNo < retData.length; intNo++) {
      ...
      if (stringkey.startsWith(stringPathKey)) {
        ...
        if (!"".equals(stringDefaultPath)) {
          File dir = new File(stringDefaultPath);
  ...
  public void doRecordPath(String stringPathKey, String stringChoicePath, String stringDefaultPath) throws Throwable {
    ...
    //
    File fileDir = new File(stringFilePath);
  ...
  public String doNumToTranum(String stringNum) throws Exception {
    ...
    for (int intNo = 0; intNo < intMax; intNo++) {
      ...
      //
      booleanFlow = !"".equals(stringTxt1) && (!"零".equals(stringTxt1) || ((intMax - intNo - 1) % 4) == 0);
      if (booleanFlow) {
      ...
      booleanFlow = ("零".equals(stringLast) && "零".equals(stringTxt1)) || ("零".equals(stringTxt1) && !"".equals(stringTxt2));
      if (booleanFlow) stringTxt1 = "";
      // System.out.println(intNo+"(stringTxt1)-------------------"+stringTxt1) ;
      //
      booleanFlow = "零".equals(stringLast) && (intMax - intNo - 1) % 4 == 0 && ("零".equals(stringTxt1) || "".equals(stringTxt1));
  ...
  public String getAddTime(String stringDateTime, String stringType, int intAddNum) throws Throwable {
    ...
    //
    arrayDateTime = convert.StringToken(stringDateTime, " ");
    if (arrayDateTime.length != 2) return "";
    stringDate = arrayDateTime[0].trim();
    stringTime = arrayDateTime[1].trim();
    arrayDateTime = convert.StringToken(stringTime, ":");
    if (arrayDateTime.length != 3) return "";
  ...
  public long getSubSecond(String stringDateTimeAfter, String stringDataeTimeBefore) throws Throwable {
    ...
    stringDateAfter = arrayDateTime[0].trim();
    stringDateAfter = getDateConvert(stringDateAfter);
    stringTimeAfter = arrayDateTime[1].trim();
    arrayDateTime = convert.StringToken(stringDataeTimeBefore, " ");
    stringDateBefore = arrayDateTime[0].trim();
    stringDateBefore = getDateConvert(stringDateBefore);
  ...
  public long getTimeToSecond(String stringTime) throws Throwable {
    long longSecond = 0;
    if (stringTime.length() > 8) stringTime = stringTime.substring(stringTime.length() - 8, stringTime.length());
  ...
  public boolean doSaveFile(String stringServerPath, String StringReplace) throws Throwable {
    ...
    if (arrayTemp.length == 1) arrayTemp = convert.StringToken(stringServerPath, "/");
    String stringClientPath = "C:\\Emaker_Util";
    (new File(stringClientPath)).mkdir();
  ...
  public boolean doSaveFile(String stringServerPath, String stringClientPath, String StringReplace) throws Throwable {
    byte[] arrayByteFile = getByte(stringServerPath);
    if (arrayByteFile == null) return false;
    File fileT = new File(stringClientPath);
    if (!"Y".equals(StringReplace) && fileT.exists()) {
      System.out.println("[" + stringClientPath + "]已存在");
      return true;
    }
    try {
  ...
  /**
   * 刪除檔 stringFilePathAndName 檔路徑及名稱 如c:/fqf.txt
   */
  ...
  /**
   * 複製單個檔 stringOldPath 原檔路徑 如：c:/fqf.txt stringNewPath 複製後路徑 如：f:/fqf.txt
   * (檔名有空白，會造成錯誤)
   */
  ...
  public String getVoucherEmpNo(String stringUser, String stringComNo) throws Throwable {
    ...
    /*
     * if(",B3680,".indexOf(stringUser) != -1) { stringUser = stringUser+"00" ; }
     */
    // 趙洋寬 已離職 2013-12-13 取消此轉換
    /*
     * if(!"".equals(stringComNo) && "01,12,".indexOf(stringComNo)!=-1 &&
     * "B4246".equals(stringUser)) { stringUser = stringUser+"00" ; }
     */
    // 詹喬巽 2017-09-04
    ...
    /*
     * (if(!"".equals(stringComNo) && "12,".indexOf(stringComNo)!=-1 &&
     * "B3437".equals(getUser())) { stringUser = stringUser+"01" ; }
     */
    return stringUser;
  }
  ...
  public double getTableFieldSum(String stringFieldName, String stringTableName, String stringSqlAnd, Hashtable hashtableAnd, talk dbCon) throws Throwable {
    ...
    for (int intNo = 0; intNo < vectorTableData.size(); intNo++) {
      hashtableTemp = (Hashtable) vectorTableData.get(intNo);
  ...
  public Vector getQuerySumData(String stringTableName, Hashtable hashtableAnd, String stringSelectSql, String stringSqlAnd, talk dbCon) throws Throwable {
    ...
    for (int intNo = 0; intNo < retColumnsData.length; intNo++) {
      ...
      // AND
      stringColumnValue = (String) hashtableAnd.get(stringColumnName);
      if (stringColumnValue == null) continue;
      //
    ...
    //
    String stringSql = " SELECT " + stringSelectSql + " \n" + " FROM  " + stringTableNameT + " \n" + stringWhereSql + stringSqlAnd;
    // 資料取得
    String[][] retData = new String[0][0];
    boolean booleanFlag = !"".equals(stringSelectSql) && !"".equals(stringTableNameT) && (!"".equals(stringWhereSql) || !"".equals(stringSqlAnd));
  ...
  public Vector getQueryDataHashtableUnion(String stringTableName, Hashtable hashtableAnd, String stringSqlAnd, Vector vectorColumnName, talk dbCon) throws Throwable {
    ...
    String stringColumnValue = "";
    String stringTableNameT = convert.StringToken(stringTableName, "%-%")[0]; // 避免不同資料庫，相同表格名稱時，[表格]%-%[資料庫]
    String stringIsNull = "" + hashtableAnd.get("ISNULL");
    hashtableAnd.remove("ISNULL");
    String[][] retColumnsData = null;
  ...
  public String doInsertDB(String stringTableName, Hashtable hashtableData, boolean booleanDB, talk dbCon) throws Throwable {
    ...
    for (int intNo = 0; intNo < retColumnsData.length; intNo++) {
      stringColumnName = retColumnsData[intNo][0].trim();
      stringColumnType = retColumnsData[intNo][2].trim();
      stringColumnValue = (String) hashtableData.get(stringColumnName);
      if (stringColumnValue == null) continue;
      // INSERT FIELD
    ...
    boolean booleanFlag = booleanDB && !"".equals(stringTableNameT) && !"".equals(stringInsertNameSql) && !"".equals(stringInsertValueSql);
  ...
  public String doUpdateDB(String stringTableName, String stringSqlAnd, Hashtable hashtableData, Hashtable hashtableAnd, boolean booleanDB, talk dbCon) throws Throwable {
    ...
    boolean booleanFlag = booleanDB && !"".equals(stringTableNameT) && !"".equals(stringUpdateDataSql) && (!"".equals(stringWhereSql) || !"".equals(stringSqlAnd));
    if (booleanFlag) dbCon.execFromPool(stringSql);
    return stringSql;
  }
  ...
  public String doDeleteDB(String stringTableName, Hashtable hashtableAnd, String stringSqlAnd, boolean booleanDB, talk dbCon) throws Throwable {
    ...
    //
    boolean booleanFlag = booleanDB && !"".equals(stringTableNameT) && (!"".equals(stringWhereSql) || !"".equals(stringSqlAnd));
    if (booleanFlag) dbCon.execFromPool(stringSql);
    return stringSql;
  }
